...
// Check if a custom DATABASE_URL was parsed properly
$hasCustomUrl = !empty($parsedDatabaseUrl['host']);

define('DB_HOST', $hasCustomUrl ? $parsedDatabaseUrl['host'] : firstEnvValue(['MYSQLHOST', 'DB_HOST'], 'localhost'));
define('DB_PORT', (int) ($hasCustomUrl ? $parsedDatabaseUrl['port'] : firstEnvValue(['MYSQLPORT', 'DB_PORT'], '3306')));
define('DB_USER', $hasCustomUrl ? $parsedDatabaseUrl['user'] : firstEnvValue(['MYSQLUSER', 'DB_USER', 'DB_USERNAME'], 'root'));
define('DB_PASS', $hasCustomUrl ? $parsedDatabaseUrl['pass'] : firstEnvValue(['MYSQLPASSWORD', 'DB_PASS', 'DB_PASSWORD'], ''));
define('DB_NAME', $hasCustomUrl ? $parsedDatabaseUrl['name'] : firstEnvValue(['MYSQLDATABASE', 'DB_NAME', 'DB_DATABASE'], 'osas_db'));
