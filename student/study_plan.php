...
$planning_status = $stats['planning_status'] ?? ($policy_gate['planning_status'] ?? [
    'is_irregular' => false,
    'label' => 'Regular',
    'reasons' => [],
]);
        ...
        <div class="academic-overview">
            ...
            <div style="margin-top: 15px; padding: 12px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px; font-size: 12px;">
                ...
                <div id="cache-warning" style="margin-top: 5px; color: #d32f2f; font-weight: bold; display: none;">
                    Warning: CACHED DATA DETECTED! Press Ctrl+Shift+R to refresh!
                </div>
            </div>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            if (hasMismatch) {
                ...
                if (warningDiv) {
                    ...
                    warningDiv.innerHTML = 'Warning: CACHED DATA! Server says: ' + phpCompletion + '% (' + phpCompleted + '/57). Press Ctrl+Shift+R NOW!';
                }
                ...
                warningBanner.innerHTML = 'Warning: DISPLAYING CACHED DATA! Real completion: ' + phpCompletion + '% (' + phpCompleted + ' courses). Press Ctrl+Shift+R to see correct data!';
